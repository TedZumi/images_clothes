...
class User:
    def __init__(self, id, username, email, password_hash, wardrobe, dbase):
        self.id = id
    ...
    def get(user_id, dbase):
        ...
        if user_data:
            return User(user_data.id, user_data.username, user_data.email, user_data.password_hash, user_data.wardrobe, dbase)
        else:
            return None
